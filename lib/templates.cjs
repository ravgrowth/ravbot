function codeEmailHTML({ brand = "RavGrowth", code, mins = 10 }) {
  return `<!DOCTYPE html>
...
function emailChangedHTML({ brand = "RavGrowth", oldEmail, newEmail, link }) {
  return `<!DOCTYPE html>
...
function emailUpdatedHTML({ brand = "RavGrowth", newEmail, link }) {
  return `<!DOCTYPE html>
...
function niceEmail({ title, bodyHTML, buttonText, buttonLink }) {
  return `
  <!DOCTYPE html>
  <html>
    <head>
...
function codeEmailText({ brand = "RavGrowth", code, mins = 10 }) {
